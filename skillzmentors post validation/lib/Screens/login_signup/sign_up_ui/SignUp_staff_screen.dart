...
class Signup_Staff_Page extends StatelessWidget {
  const Signup_Staff_Page({super.key});
              ...
              child: BlocBuilder<SignupBloc, SignupState>(
                builder: (context, state) {
                  if (state is PersonalDetailsState) {
                    ...
                    return _buildAddressDetailsForm(context);
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                context.read<SignupBloc>().add(NextStepEvent());
              },
  ...
  Widget _buildAddressDetailsForm(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: SingleChildScrollView(
        child: Column(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      context.read<SignupBloc>().add(PreviousStepEvent());
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.blue,
                      shape: RoundedRectangleBorder(
